...
//-------------------------------------------------------------------------------------------------------------------
void gpio_init(PIN_enum pin, GPIODIR_enum dir, uint8_t dat, uint32_t pinconf)
{
...
//-------------------------------------------------------------------------------------------------------------------
void gpio_set(PIN_enum pin, uint8_t dat)
{
...
//  Sample usage:           uint8_t status = gpio_get(D5);//获取D5引脚电平
//-------------------------------------------------------------------------------------------------------------------
uint8_t gpio_get(PIN_enum pin)
{
...
//-------------------------------------------------------------------------------------------------------------------
void gpio_interrupt_init(PIN_enum pin, TRIGGER_enum trigger, uint32_t pinconf)
{
    gpio_pin_config_t gpio_config;
...
//-------------------------------------------------------------------------------------------------------------------
void fast_gpio_init(PIN_enum pin, GPIODIR_enum dir, uint8_t dat, uint32_t pinconf)
{
    iomuxc_pinconf(pin,ALT5,pinconf);
...
//-------------------------------------------------------------------------------------------------------------------
void fast_gpio_set(PIN_enum pin, uint8_t dat)
{
...
//  @param      pin         选择的引脚 (可选择范围由 common.h 内PIN_enum枚举值确定)
//  @return     uint8_t       0：低电平 1：高电平
//  Sample usage:           uint8_t status = fast_gpio_get(D5);//获取D5引脚电平
//-------------------------------------------------------------------------------------------------------------------
uint8_t fast_gpio_get(PIN_enum pin)
{
