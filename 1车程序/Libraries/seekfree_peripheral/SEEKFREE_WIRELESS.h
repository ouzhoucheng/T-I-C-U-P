...
#define WIRELESS_UART        USART_1         //无线转串口模块 所使用到的串口     
#define WIRELESS_UART_TX     UART1_TX_B12
#define WIRELESS_UART_RX     UART1_RX_B13
...
uint32_t  seekfree_wireless_send_buff(uint8_t *buff, uint32_t len);
