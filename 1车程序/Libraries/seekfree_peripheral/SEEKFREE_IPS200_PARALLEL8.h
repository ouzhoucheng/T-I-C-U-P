...
#define IPS200_RD_PIN  		B10
#define IPS200_WR_PIN  		B11
#define IPS200_RS_PIN  		C31
#define IPS200_RST_PIN 		B9
#define IPS200_CS_PIN  		B21
#define IPS200_BL_PIN  		C7
...
#define IPS200_D0_PIN 		C20
#define IPS200_D1_PIN 		C21
#define IPS200_D2_PIN 		C22
#define IPS200_D3_PIN 		C23
#define IPS200_D4_PIN 		C24
#define IPS200_D5_PIN 		C25
#define IPS200_D6_PIN 		C26
#define IPS200_D7_PIN 		C27
...
//定义数据端口所在PORT，切换引脚后务必根据引脚所在PORT进行更改
#define IPS200_DATA_PORT1    2       //1：B端口  2：C端口  3：D端口
