...
uint8_t usb_cdc_com_open_flag;
uint8_t usb_cdc_com_first_flag;
...
//-------------------------------------------------------------------------------------------------------------------
void usb_cdc_send_char(uint8_t dat)
{
...
//-------------------------------------------------------------------------------------------------------------------
void usb_cdc_send_str(const int8_t *str)
{
	uint16_t delay_num=0;
	...
	if(usb_cdc_com_open_flag)
	{
		...
		USB_DeviceCdcAcmSend(s_cdcVcom.cdcAcmHandle, USB_CDC_VCOM_BULK_IN_ENDPOINT, (uint8_t *)str, strlen(str));
	}
}
...
//-------------------------------------------------------------------------------------------------------------------
void usb_cdc_send_buff(uint8_t *p, uint32_t length)
{
	uint16_t delay_num=0;
