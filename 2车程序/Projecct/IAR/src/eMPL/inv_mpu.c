 ...
 * min(int a, int b)
 */
void myget_ms(unsigned long *count){}
...
#define i2c_write(addr, reg, len, data)   MPU_Write_Len(addr, reg, len, data)
#define i2c_read(addr, reg, len, data)    MPU_Read_Len(addr, reg, len, data) 
