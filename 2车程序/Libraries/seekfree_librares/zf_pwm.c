...
//-------------------------------------------------------------------------------------------------------------------
void pwm_init(PWMCH_enum pwmch, uint32_t freq, uint32_t duty)
{
    uint8  pwm_num;
    uint8  pwm_module;
    uint8  pwm_module_ch;
...
//							PWM_DUTY_MAX在fsl_pwm.h文件中 默认为50000
//-------------------------------------------------------------------------------------------------------------------
void pwm_duty(PWMCH_enum pwmch, uint32_t duty)
{
    uint8  pwm_num;
    uint8  pwm_module;
    uint8  pwm_module_ch;
...
//-------------------------------------------------------------------------------------------------------------------
void pwm_freq(PWMCH_enum pwmch, uint32_t freq, uint32_t duty)
{
    uint8  pwm_num;
    uint8  pwm_module;
    uint8  pwm_module_ch;
